...
# my solution, not sure why it was not working, to verify
def lps(input_string):
    ...
    for idx_b, b in enumerate(input_string):
        for idx_a, a in enumerate(input_string):
            if idx_a >= idx_b:
                pass
            elif a == b:
                matrix[idx_a][idx_b] = matrix[idx_a+1][idx_b-1] + 2
            else:
                matrix[idx_a][idx_b] = max(matrix[idx_a][idx_b-1],
